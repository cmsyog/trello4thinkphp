...
window.NetYog = {
    ...
    setWindowMaxWidth: function(){
        ...
        //不清楚为何*3去掉恢复正常
        var maxPreferredWidth = (screen.width>screen.height? screen.width: screen.height);
    ...
    addCardDialog: function(ctx){
        ...
        $('#cardDesc > textarea').blur(function(){
            ...
            $.ajax('/admin.php/Board/cardDescription', {
    ...
    init: function (element, valueAccessor, allBindingsAccesor, context) {
        ...
        $element.sortable({
            ...
            stop : function(event, uib){
                ...
                $.ajax('/admin.php/Board/cardPosition',{
    ...
    init: function (element, valueAccessor, allBindingsAccesor, context) {
        ...
        $element.sortable({
            ...
            stop : function(event, uib){
                ...
                $.ajax('/admin.php/Board/listPosition', {
